...
<img src="/img/developing/previewing/chrome-dev-tools.png" alt="Chrome 开发者工具" />

在此界面，您可以从下拉菜单中选择不同的设备类型，更改设备方向以及限制网络速度。

如需了解更多功能和信息，请访问：https://developer.chrome.com/devtools/device-mode/
...
<img src="/img/developing/previewing/safari-responsive-design-mode.png" alt="Safari 响应式设计模式" />
...
<img src="/img/developing/previewing/firefox-responsive-design-mode.png" alt="Firefox 响应式设计模式" />
