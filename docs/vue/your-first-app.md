...
在 GitHub 上找到本指南中引用的[完整应用代码](https://github.com/ionic-team/tutorial-photo-gallery-vue)。
...
接下来，创建一个使用"Tabs"启动模板并添加 Capacitor 以实现原生功能的 Ionic Vue 应用：
...
![显示 Ionic 应用中 Live Reload 功能的动画 GIF，代码更改立即反映在 Web 浏览器中。](/img/guides/vue/first-app/live-reload.gif 'Ionic 应用中的 Live Reload 功能')
