...
<head>
  <title>ion-route：Ionic Framework 应用的 API 路由组件</title>
  <meta name="description" content="ion-route 组件接受一个组件，并在浏览器 URL 匹配 url 属性时渲染它。了解更多关于 Ionic 应用的 API 路由组件的信息。" />
</head>
