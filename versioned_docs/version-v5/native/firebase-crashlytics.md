...
一个用于捕获崩溃报告的 Google Firebase Crashlytics 插件。

<p>
  <a href="https://github.com/ReallySmallSoftware/cordova-plugin-firebase-crashlytics" target="_blank" rel="noopener" className="git-link">github.com/ReallySmallSoftware/cordova-plugin-firebase-crashlytics</a>
</p>
...
>
  <div>
    ...
    <p>如果您正在构建一个严肃的项目，您负担不起花费数小时进行故障排查。Ionic 的专家为社区插件和高级插件提供优质的咨询服务。</p>
