...
本插件用于实现原生代码与您的应用之间的事件交互。

<p>
  <a href="https://github.com/bsorrentino/cordova-broadcaster" target="_blank" rel="noopener" className="git-link">github.com/bsorrentino/cordova-broadcaster</a>
</p>
...
>
  <div>
    ...
    <p>如果您正在开发一个严肃的项目，您无法承受花费数小时进行故障排查的代价。Ionic 专家为社区插件和高级插件提供优质的咨询服务。</p>
