...
<p>
  <a href="https://github.com/vstirbu/InstagramPlugin" target="_blank" rel="noopener" className="git-link">github.com/vstirbu/InstagramPlugin</a>
</p>
...
>
  <div>
    ...
    <p>如果你正在开发一个严肃的项目，无法承受数小时故障排除的代价。Ionic 专家为社区插件和高级插件提供优质咨询服务。</p>
...
>
  ...
  <TabItem value="Enterprise">
    <blockquote>
      Ionic Enterprise 包含由 Ionic 团队完全支持和维护的插件。&nbsp;
