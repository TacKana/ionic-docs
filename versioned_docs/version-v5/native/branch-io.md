...
Branch.io 是一款用于深度链接和邀请链接的归因服务

<p>
  <a href="https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking" target="_blank" rel="noopener" className="git-link">github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking</a>
</p>
...
>
  <div>
    ...
    <p>如果您正在构建一个严肃的项目，您无法承受花费数小时进行故障排除的代价。Ionic 专家为社区插件和高级插件提供优质的咨询服务。</p>
...
>
  ...
  <TabItem value="Enterprise">
    <blockquote>
      Ionic 企业版提供由 Ionic 团队完全支持与维护的插件。&nbsp;
