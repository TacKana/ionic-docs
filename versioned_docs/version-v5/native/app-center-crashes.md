...
App Center Analytics 帮助您了解用户行为和客户参与度，从而优化您的应用。
SDK 会自动捕获会话次数和设备属性，例如型号、操作系统版本等。
您可以定义自定义事件来追踪对您而言重要的指标。
所有捕获的信息都可在 App Center 门户中查看，供您分析数据。

更多信息，请参阅 https://docs.microsoft.com/en-us/appcenter/sdk/crashes/cordova
...
>
  <div>
    ...
    <p>如果您正在进行一个严肃的项目，承担不起数小时排查问题的时间。Ionic 专家为社区插件和高级插件提供优质的咨询服务。</p>
