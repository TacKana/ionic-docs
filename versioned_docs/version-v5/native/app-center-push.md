...
如需更多信息，请访问 https://docs.microsoft.com/en-us/appcenter/sdk/push/cordova
...
>
  <div>
    ...
    <p>如果你正在开发一个重要项目，承担不起花费数小时排查故障的代价。Ionic 专家为社区插件和高级插件提供优质咨询服务。</p>
...
>
  ...
  <TabItem value="Enterprise">
    <blockquote>
      ...
      <a className="btn" href="https://ionic.io/docs/premier-plugins">了解更多</a> 或若你对本插件的企业版感兴趣 <a className="btn" href="https://ionicframework.com/sales?product_of_interest=Ionic%20Enterprise%20Engine">联系我们</a>
    </blockquote>
  </TabItem>
</Tabs>
...
this.appCenterPush.setEnabled(true).then(() => {
   this.appCenterPush.addEventListener('My Event').subscribe(pushNotification => {
       console.log('接收到推送通知', pushNotification);
   });
});
