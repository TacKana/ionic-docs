...
需要 Cordova 插件：cordova-sms-plugin。更多信息请查看 [SMS 插件文档](https://github.com/cordova-sms/cordova-sms-plugin)。

<p>
  <a href="https://github.com/cordova-sms/cordova-sms-plugin" target="_blank" rel="noopener" className="git-link">github.com/cordova-sms/cordova-sms-plugin</a>
</p>
...
>
  <div>
    ...
    <p>如果您正在开发一个严肃的项目，不能把时间浪费在故障排除上。Ionic 的专家为社区插件和高级插件提供优质的咨询服务。</p>
