...
为你的 Cordova 应用提供一个跨平台的 WhatsApp / Messenger / Slack 风格键盘事件。

<p>
  <a href="https://github.com/EddyVerbruggen/cordova-plugin-native-keyboard" target="_blank" rel="noopener" className="git-link">github.com/EddyVerbruggen/cordova-plugin-native-keyboard</a>
</p>
...
>
  <div>
    ...
    <p>如果你正在开发一个严肃的项目，就无法承受花费数小时进行故障排除。Ionic 的专家为社区插件和高级插件提供优质的咨询服务。</p>
