...
一个 Apache Cordova 插件，允许应用程序手动将主机名解析为底层网络地址。这主要用于判断设备的 DNS 服务器配置是否存在问题。

<p>
  <a href="https://bitbucket.org/zegeba/cordova-plugin-dns" target="_blank" rel="noopener" className="git-link">bitbucket.org/zegeba/cordova-plugin-dns</a>
</p>
