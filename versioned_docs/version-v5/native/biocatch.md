...
BioCatch SDK Cordova 插件支持

<p>
  <a href="https://bitbucket.org/carlos_orellana/ionic-plugin" target="_blank" rel="noopener" className="git-link">bitbucket.org/carlos_orellana/ionic-plugin</a>
</p>
