...
一款 Ionic 插件，用于在 iPhone 7、7 Plus 或更新机型上调用 Taptic Engine API。

<p>
  <a href="https://github.com/EddyVerbruggen/cordova-plugin-taptic-engine" target="_blank" rel="noopener" className="git-link">github.com/EddyVerbruggen/cordova-plugin-taptic-engine</a>
</p>
...
>
  <div>
    ...
    <p>如果您正在开发一个严肃的项目，您无法承受花费数小时进行故障排查的代价。Ionic 的专家为社区插件和高级插件提供优质的咨询服务。</p>
...
>
  ...
  <TabItem value="Enterprise">
    <blockquote>
      Ionic Enterprise 包含了由 Ionic 团队提供全面支持和维护的插件。 &nbsp;
