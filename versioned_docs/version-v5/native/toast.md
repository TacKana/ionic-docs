...
此插件允许您在 iOS、Android 和 WP8 上显示原生 Toast（一种小型文本弹窗）。它非常适合展示非侵入式的原生通知，确保通知始终位于浏览器视口内。

需要 Cordova 插件：`cordova-plugin-x-toast`。更多信息，请参阅 [Toast 插件文档](https://github.com/EddyVerbruggen/Toast-PhoneGap-Plugin)。
