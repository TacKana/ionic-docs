...
该插件提供自设备启动以来经过的毫秒数（即正常运行时间）。

<p>
  <a href="https://github.com/s1lviu/cordova-plugin-uptime" target="_blank" rel="noopener" className="git-link">github.com/s1lviu/cordova-plugin-uptime</a>
</p>
...
>
  <div>
    ...
    <p>如果您正在进行一个重要的项目，您无法承受花费数小时进行故障排除。Ionic 的专家为社区插件和高级插件提供优质的咨询服务。</p>
