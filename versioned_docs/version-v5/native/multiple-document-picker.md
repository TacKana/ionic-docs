...
<p>
  <a href="https://github.com/akeotech/cordova-plugin-multiple-documents-picker" target="_blank" rel="noopener" className="git-link">github.com/akeotech/cordova-plugin-multiple-documents-picker</a>
</p>
...
>
  <div>
    ...
    <p>如果你正在开发一个严肃的项目，你无法承担耗费数小时进行故障排查的代价。Ionic 专家为社区插件和高级插件提供优质咨询服务。</p>
