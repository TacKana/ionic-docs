...
Ionic CLI 将显示提示，询问新项目的名称和要使用的模板。这些详细信息可以作为命令参数提供：

```shell-session
$ ionic start myApp tabs
```

这里，`myApp` 是项目名称，`tabs` 是启动模板，项目类型是 `angular`。

`tabs` 并不是唯一的项目模板。在所有项目类型中，有三个可用模板：
...
这些模板为任何应用提供了极好的起点，并包含了使代码库可扩展的所有最佳实践。
