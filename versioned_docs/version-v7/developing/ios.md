---
title: iOS 开发
sidebar_label: 开发 iOS 应用
skipIntros: true
---

<head>
  <title>iOS 应用开发指南：搭建 Xcode 以构建和运行 iOS 应用</title>
  <meta
    name="description"
    content="Ionic 的 iOS 开发指南介绍了如何在 iOS 模拟器和设备上构建和运行 Ionic 应用。iOS 应用只能在 macOS 上通过 Xcode 进行开发。"
  />
</head>
...
<DocsCards>
  <DocsCard
    header="使用 Capacitor 开发 iOS 应用（推荐）"
  ...
  <DocsCard
    header="使用 Cordova 开发 iOS 应用（旧版）"
