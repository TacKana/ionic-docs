...
<head>
  ...
  <meta
    name="description"
    content="了解 Angular 如何通过 ngFor 配合 Ionic 组件管理变更传播。阅读更多关于 Ionic 应用中 Angular 性能优化的信息。"
  />
</head>
...
[Ionic 框架很快（但您的代码可能不快）](https://www.joshmorony.com/ionic-framework-is-fast-but-your-code-might-not-be/) - Josh Morony
