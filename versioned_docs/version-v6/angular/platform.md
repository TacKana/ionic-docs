...
<head>
  ...
  <meta
    name="description"
    content="Ionic 平台服务可用于获取当前设备信息。通过这些信息，您可以完全自定义您的应用以适应任何设备。"
  />
</head>

Platform 服务可用于获取当前设备的信息。您可以使用 `platforms` 方法获取与设备关联的所有平台信息，包括应用是否在平板电脑上查看、是否在移动设备或浏览器中运行，以及具体平台（iOS、Android 等）。您还可以获取设备的方向、是否使用从右到左的语言方向等等。通过这些信息，您可以完全自定义您的应用以适应任何设备。
...
|                 |                                                                                                                                                                                                                                                                                                                                                                           |
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **描述**        | 根据用户所在的平台，`is(platformName)` 将返回 true 或 false。请注意，同一个应用可能会对多个平台名称返回 true。例如，在 iPad 上运行的应用会对以下平台名称返回 true：`mobile`、`ios`、`ipad` 和 `tablet`。此外，如果应用是从 Cordova 运行的，则 `cordova` 将为 true。                                                                                                       |
...
|          |                                                                                                                                                                                                         |
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **描述** | 根据您所在的设备，`platforms` 可以返回多个值。每个可能的值都是一个平台层次结构。例如，在 iPhone 上，它将返回 `mobile`、`ios` 和 `iphone`。                                                              |
| **签名** | `platforms() => string[]`                                                                                                                                                                               |
...
|          |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **描述** | 当平台准备就绪且可以调用原生功能时返回一个 Promise。如果应用在 Web 浏览器中运行，则 Promise 将在 DOM 准备就绪时解析。当应用在应用引擎（如 Cordova）中运行时，则 Promise 将在 Cordova 触发 `deviceready` 事件时解析。解析后的值是 `readySource`，它指明了所使用的平台。<br /><br />例如，当 Cordova 准备就绪时，解析的 ready source 是 `cordova`。默认的 ready source 值是 `dom`。`readySource` 很有用，因为根据应用运行的平台，可能需要运行不同的逻辑。例如，只有 Capacitor 和 Cordova 可以执行状态栏插件，因此 Web 不应运行状态栏插件逻辑。 |
...
|          |                                                                                                                                                                                                                                                                                                                                    |
| -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **描述** | 返回此应用是否使用从右到左的语言方向。我们建议应用的 `index.html` 文件已设置了正确的 `dir` 属性值，例如 `<html dir="ltr">` 或 `<html dir="rtl">`。[W3C：HTML 中的结构化标记和从右到左文本](http://www.w3.org/International/questions/qa-html-dir) |
| **签名** | `isRTL() => boolean`                                                                                                                                                                                                                                                                                                               |
...
当原生平台将应用程序置于后台时（通常是用户切换到其他应用程序时），会触发 `pause` 事件。当 Cordova/Capacitor 应用被置于后台时，此事件会触发，但在标准 Web 浏览器中不会触发。
...
当浏览器窗口的尺寸发生变化时，会触发 `resize` 事件。这可能是由于浏览器窗口被实际调整大小，或设备方向发生变化。
...
当原生平台将应用程序从后台拉回前台时，会触发 `resume` 事件。当 Cordova/Capacitor 应用从后台返回时，此事件会触发，但在标准 Web 浏览器中不会触发。
