...
<head>
  ...
  <meta
    name="description"
    content="为了构建 Ionic 应用，你首先需要选择计划使用的 JavaScript 框架。了解更多关于使用 Ionic 启动应用的后续步骤。"
  />
</head>
