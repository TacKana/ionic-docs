...
<template>
  <ion-content :scroll-y="false">
    <div class="ion-content-scroll-host ion-padding">
      ...
      />
      <p>
        犀牛的名字来源于它最显著的特征之一——它的角。“犀牛”这个词源自希腊语，rhino意为“鼻子”，ceros意为“角”。犀牛角的数量因物种而异。两种非洲犀牛（黑犀牛和白犀牛）以及苏门答腊犀牛都有两只角，而爪哇犀牛和独角犀牛则只有一只角。
      </p>
      ...
      />
      <p>
        海龟的特征是拥有一个大型、流线型的甲壳，以及无法缩回头部和四肢。与其他龟类不同，海龟不能将四肢和头部缩回壳内。它们的四肢是适应游泳的鳍状肢，因此在陆地上时非常脆弱。
      </p>
      ...
      />
      <p>
        长颈鹿以其修长高挑的外形而闻名。它们的背上有一个像骆驼一样的小驼峰，并且拥有类似豹子的斑点花纹。由于这些特征的结合，一些人称长颈鹿为“骆驼豹”。这也正是长颈鹿的物种名“camelopardalis”的由来。
      </p>
      ...
      />
      <p>
        大象是现存最大的陆地动物，拥有庞大的身躯、巨大的耳朵和长长的象鼻。大象的长鼻子功能多样，可以用来拾取物体、发出警告声、问候其他大象，或者吸水来喝或洗澡。
      </p>
      ...
      />
      <p>
        海豚的颜色因物种而异，从白色、珍珠色、粉色到更深的棕色、灰色、蓝色和黑色不等。它们拥有光滑的皮肤、鳍状肢和背鳍。它们有细长的吻部，约有100颗牙齿，以及流线型的身体。它们的头顶有一个单一的呼吸孔，上面有一个可以打开露出鼻孔的瓣膜。海豚浮出水面时就用这些鼻孔呼吸。
      </p>
    </div>
  </ion-content>
