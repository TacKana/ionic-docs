...
<ion-content [scrollY]="false">
  <div class="ion-content-scroll-host ion-padding">
    ...
    />
    <p>
      犀牛因其最显著的特征之一而得名：它的角。“rhinoceros”一词源于希腊语，rhino意为“鼻子”，ceros意为“角”。不同种类的犀牛，角的数量也不同。两种非洲犀牛（黑犀牛和白犀牛）以及苏门答腊犀牛都有两只角，而爪哇犀牛和印度犀牛则只有一只角。
    </p>
    ...
    />
    <p>
      海龟的特征是拥有一个大型流线型甲壳，以及无法缩回的头和四肢。与其他龟类不同，海龟无法将四肢和头部缩进壳内。它们的四肢是适应游泳的鳍状肢，因此在陆地上时非常脆弱。
    </p>
    ...
    />
    <p>
      长颈鹿以其修长高大的外形而闻名。它们背上有一个类似骆驼的小驼峰，身上的斑纹则与豹子相似。由于这些特征的结合，有些人曾称长颈鹿为“骆驼豹”。这正是长颈鹿学名“camelopardalis”的由来。
    </p>
    ...
    />
    <p>
      大象是现存最大的陆地动物，拥有庞大的身躯、大耳朵和长长的鼻子。大象的长鼻子功能多样，可用于拾取物品、发出警告声、与同伴打招呼，或是吸水来喝或洗澡。
    </p>
    ...
    />
    <p>
      海豚的颜色因种类而异，从白色、珍珠色、粉色到较深的棕色、灰色、蓝色和黑色。它们拥有光滑的皮肤、鳍状肢和背鳍。它们有一个细长的吻部，大约有100颗牙齿，身体呈流线型。头顶有一个单一的喷水孔，上面有一个可打开的瓣膜，露出一对鼻孔。海豚浮出水面时就用这些鼻孔呼吸。
    </p>
  </div>
</ion-content>
