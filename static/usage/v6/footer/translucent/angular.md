...
<ion-content [fullscreen]="true" class="ion-padding">
  ...
  />
  <p>
    犀牛得名于其最显著的特征——角。Rhinoceros一词源自希腊语，rhino意为“鼻子”，ceros意为“角”。不同种类的犀牛角数量各异：非洲的两种犀牛（黑犀牛和白犀牛）以及苏门答腊犀牛拥有两只角，而爪哇犀牛和印度犀牛则只有一只角。
  </p>
  ...
  />
  <p>
    海龟的特征是拥有流线型的大龟壳，且头部和四肢无法缩入壳内。与其他龟类不同，海龟不能将四肢和头缩进壳里。它们的四肢演化成了适于游泳的鳍状肢，因此在陆地上时非常脆弱。
  </p>
  ...
  />
  <p>
    长颈鹿以其高挑的身形而闻名。它们背上有一个类似骆驼的小驼峰，身上的斑纹则与豹子相似。由于这些特征的结合，有人曾称长颈鹿为“骆驼豹”。这也正是其物种名“camelopardalis”的由来。
  </p>
  ...
  />
  <p>
    大象是现存最大的陆地动物，拥有庞大的身躯、大耳朵和长鼻子。大象的长鼻子功能多样：可以用来拾取物品、发出警告声、与其他大象打招呼，或是吸水饮用或洗澡。
  </p>
  ...
  />
  <p>
    海豚的颜色因种类而异，从白色、珍珠色、粉色到较深的棕色、灰色、蓝色和黑色不等。它们拥有光滑的皮肤、鳍状肢和背鳍，以及细长的吻部（约有100颗牙齿）和流线型的身体。头顶有一个喷水孔，孔盖打开时会露出一对鼻孔。海豚浮出水面时就是用这些鼻孔呼吸的。
  </p>
</ion-content>
