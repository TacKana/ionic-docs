    ...
    <>
      ...
      <IonContent scrollY={false}>
        <div className="ion-content-scroll-host ion-padding">
          ...
          />
          <p>
            犀牛的名字来源于它最显著的特征之一：它的角。Rhinoceros 一词源自希腊语，rhino 意为“鼻子”，ceros 意为“角”。不同种类的犀牛角的数量也不同。两种非洲犀牛（黑犀牛和白犀牛）以及苏门答腊犀牛有两个角，而爪哇犀牛和独角犀牛只有一个角。
          </p>
          ...
          />
          <p>
            海龟的特征是拥有一个大型的流线型甲壳，以及无法缩回壳内的头部和四肢。与其他龟类不同，海龟不能将四肢和头部缩回壳内。它们的四肢是适应游泳的鳍状肢，因此在陆地上时非常脆弱。
          </p>
          ...
          />
          <p>
            长颈鹿以其高挑修长的外形而闻名。它们背部有一个像骆驼一样的小驼峰，身上的斑点图案类似于豹子。由于这些特征的结合，一些人称长颈鹿为“骆驼豹”。这就是长颈鹿物种名称“camelopardalis”的由来。
          </p>
          ...
          />
          <p>
            大象是现存最大的陆地动物，拥有庞大的身躯、大耳朵和长长的鼻子。大象的长鼻子功能多样，可以用来拾取物体、发出警告声、与其他大象打招呼，或者吸水饮用或洗澡。
          </p>
          ...
          />
          <p>
            海豚的颜色因物种而异，从白色、珍珠色、粉色到更深的棕色、灰色、蓝色和黑色不等。它们拥有光滑的皮肤、鳍状肢和一个背鳍。它们有一个细长的吻部，大约有100颗牙齿，身体呈流线型。它们头顶有一个单一的呼吸孔，上面有一个可以打开并露出一对鼻孔的皮瓣。海豚浮出水面时就用这些鼻孔呼吸。
          </p>
        </div>
      </IonContent>
    </>
