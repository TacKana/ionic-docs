...
<ion-content [scrollY]="false">
  <div class="ion-content-scroll-host ion-padding">
    ...
    />
    <p>
      犀牛的名字来源于其最显著的特征之一：犀牛角。“犀牛”这个词源自希腊语，“rhino”意为“鼻子”，“ceros”意为“角”。不同种类的犀牛，角的数量也不同。非洲的两种犀牛（黑犀牛和白犀牛）以及苏门答腊犀牛有两个角，而爪哇犀牛和印度犀牛则只有一个角。
    </p>
    ...
    />
    <p>
      海龟的特征是拥有一个大型、流线型的甲壳，以及无法缩回的头部和四肢。与其他龟类不同，海龟无法将四肢和头部缩回壳内。它们的四肢是适应游泳的桨状鳍，因此在陆地上时非常脆弱。
    </p>
    ...
    />
    <p>
      长颈鹿以其高挑修长的外形而闻名。它们的背上有一个类似骆驼的小驼峰，身上的斑点图案则与豹子相似。正因为这些特征的结合，有些人将长颈鹿称为“骆驼豹”。这也正是长颈鹿的物种名“camelopardalis”的由来。
    </p>
    ...
    />
    <p>
      海豚的颜色因物种而异，从白色、珍珠色、粉色到较深的棕色、灰色、蓝色和黑色不等。它们拥有光滑的皮肤、鳍状肢和一个背鳍。海豚的吻部细长，约有100颗牙齿，身体呈流线型。它们的头顶有一个单一的呼吸孔，上面有一个可以打开的瓣膜，露出一对鼻孔。海豚浮出水面时，就用这些鼻孔进行呼吸。
    </p>
  </div>
</ion-content>
```