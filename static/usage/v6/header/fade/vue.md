...
<template>
  ...
  <ion-content class="ion-padding">
    ...
    />
    <p>
      犀牛得名于其最显著的特征之一：它的角。犀牛（rhinoceros）一词源自希腊语，rhino意为“鼻子”，ceros意为“角”。犀牛角的数量因物种而异。两种非洲犀牛（黑犀牛和白犀牛）以及苏门答腊犀牛有两支角，而爪哇犀牛和印度犀牛只有一支角。
    </p>
    ...
    />
    <p>
      海龟的特征是拥有一个大型流线型甲壳，以及无法缩回的头部和四肢。与其他龟类不同，海龟无法将四肢和头部缩回壳内。它们的四肢是适应游泳的鳍状肢，因此在陆地上时非常脆弱。
    </p>
    ...
    />
    <p>
      长颈鹿以其高大修长的外形而闻名。它们的背部有一个类似骆驼的小驼峰，身上的斑纹则与豹子相似。由于这些特征的结合，有些人称长颈鹿为“骆驼豹”。这也是长颈鹿物种学名“camelopardalis”的由来。
    </p>
    ...
    />
    <p>
      海豚的颜色因物种而异，从白色、珍珠色、粉红色到更深的棕色、灰色、蓝色和黑色不等。它们拥有光滑的皮肤、鳍状肢和背鳍。它们有细长的吻部，约100颗牙齿，身体呈流线型。它们头顶有一个单一的喷气孔，孔盖打开后会露出一对鼻孔。海豚浮出水面时就用这些鼻孔呼吸。
    </p>
  </ion-content>
</template>
