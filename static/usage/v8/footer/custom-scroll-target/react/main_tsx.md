    ...
    <>
      <IonContent scrollY={false}>
        <div className="ion-content-scroll-host ion-padding">
          ...
          />
          <p>
            犀牛因其最显著的特征之一——角而得名。“犀牛”(rhinoceros)一词源于希腊语，rhino意为“鼻子”，ceros意为“角”。不同种类的犀牛角的数量也不同。两种非洲犀牛（黑犀牛和白犀牛）以及苏门答腊犀牛有两支角，而爪哇犀牛和独角犀牛则只有一支角。
          </p>
          ...
          />
          <p>
            海龟的特征是其流线型的大型甲壳，以及无法缩回的头部和四肢。与其他龟类不同，海龟无法将四肢和头部缩回壳内。它们的四肢进化成了适合游泳的鳍状肢，因此在陆地上时显得尤为脆弱。
          </p>
          ...
          />
          <p>
            长颈鹿以其修长高挑的身形而闻名。它们的背部有一个类似骆驼的小驼峰，身上的斑纹则与豹子相似。由于兼具这些特征，有些人曾称长颈鹿为“骆驼豹”。这也就是长颈鹿的物种名“camelopardalis”的由来。
          </p>
          ...
          />
          <p>
            大象是现存最大的陆地动物，拥有庞大的身躯、大耳朵和长长的鼻子。大象的长鼻子功能多样：可以用来拾取物品、发出警告声、向同伴打招呼，或是吸水用于饮用或洗澡。
          </p>
          ...
          />
          <p>
            海豚的颜色因种类而异，从白色、珍珠色、粉红色到棕色、灰色、蓝色和黑色等深色系都有。它们皮肤光滑，拥有鳍状肢和背鳍。海豚的口鼻部修长纤细，约有100颗牙齿，身体呈流线型。它们的头顶有一个单个的呼吸孔，上面有一个可打开的盖片，露出两个鼻孔。海豚浮出水面时就通过这些鼻孔进行呼吸。
          </p>
        </div>
      </IonContent>
