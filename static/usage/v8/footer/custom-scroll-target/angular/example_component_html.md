...
<ion-content [scrollY]="false">
  <div class="ion-content-scroll-host ion-padding">
    ...
    />
    <p>
      犀牛的名字来源于其最显著的特征之一：角。“犀牛”一词源自希腊语，其中“rhino”意为“鼻子”，“ceros”意为“角”。不同种类的犀牛，角的数量也不同。两种非洲犀牛（黑犀牛和白犀牛）以及苏门答腊犀牛有两个角，而爪哇犀牛和印度犀牛则只有一个角。
    </p>
    ...
    />
    <p>
      海龟的特征是具有一个大型、流线型的外壳，以及无法缩回的头部和四肢。与其他龟类不同，海龟无法将四肢和头部缩入壳内。它们的四肢是适应游泳的鳍状肢，因此在陆地上时非常脆弱。
    </p>
    ...
    />
    <p>
      长颈鹿以其高大修长的外形而闻名。它们的背上有一个类似骆驼的小驼峰，身上的斑点图案则与豹子相似。由于这些特征的结合，一些人将长颈鹿称为“骆驼豹”。这也是长颈鹿的物种名“camelopardalis”的由来。
    </p>
    ...
    />
    <p>
      大象是现存最大的陆地动物，拥有庞大的身躯、大耳朵和长长的鼻子。大象的长鼻子具有多种功能，可以用来拾取物品、发出警告的吼声、与其他大象打招呼，或者吸水用于饮用或洗澡。
    </p>
    ...
    />
    <p>
      海豚的颜色因物种而异，从白色、珍珠色和粉色到较深的棕色、灰色、蓝色和黑色不等。它们拥有光滑的皮肤、鳍状肢和背鳍。它们的吻部细长，约有100颗牙齿，身体呈流线型。头顶有一个喷水孔，上面有一个可打开的瓣膜，露出一对鼻孔。海豚浮出水面时就用这些鼻孔呼吸。
    </p>
  </div>
</ion-content>
