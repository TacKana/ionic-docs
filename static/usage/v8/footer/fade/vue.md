...
<template>
  <ion-content class="ion-padding">
    ...
    />
    <p>
      犀牛得名于其最显著的特征之一：角。Rhinoceros 一词源于希腊语，rhino 意为“鼻子”，ceros 意为“角”。不同种类的犀牛角数量也不同。两种非洲犀牛（黑犀牛和白犀牛）以及苏门答腊犀牛有两个角，而爪哇犀牛和独角犀牛则只有一个角。
    </p>
    ...
    />
    <p>
      海龟的特征是拥有巨大、流线型的外壳，以及不可伸缩的头部和四肢。与其他龟类不同，海龟无法将四肢和头部缩进壳内。它们的四肢已演化为适应游泳的鳍状肢，因此在陆地上时非常脆弱。
    </p>
    ...
    />
    <p>
      长颈鹿以其高挑修长的外形而闻名。它们的背部有一个类似骆驼的小驼峰，并拥有与豹子相似的斑点花纹。由于这些特征的结合，有些人曾称长颈鹿为“骆驼豹”。这也正是其物种学名“camelopardalis”的由来。
    </p>
    ...
    />
    <p>
      大象是现存最大的陆地动物，拥有庞大的身躯、大耳朵和长长的鼻子。大象的长鼻子功能多样，可用于拾取物品、发出警告声、问候同伴，或者吸水用于饮用或洗澡。
    </p>
    ...
    />
    <p>
      海豚的颜色因种类而异，从白色、珍珠色、粉红色到更深色调的棕色、灰色、蓝色和黑色。它们皮肤光滑，有鳍状肢和背鳍。它们拥有细长的吻部，约有100颗牙齿，身体呈流线型。头顶有一个单一的呼吸孔，上面有一个瓣膜，打开后露出一对鼻孔。海豚浮出水面时就用这些鼻孔呼吸。
    </p>
  </ion-content>
