...
<ion-content fullscreen="true" class="ion-padding">
  ...
  />
  <p>
    犀牛因其最显著的特征之一——犀角而得名。犀牛（rhinoceros）一词源自希腊语，"rhino"意为"鼻子"，"ceros"意为"角"。不同种类的犀牛，角的数量也有所不同。非洲的两种犀牛（黑犀牛和白犀牛）以及苏门答腊犀牛都长有两只角，而爪哇犀牛和印度犀牛则只有一只角。
  </p>
  ...
  />
  <p>
    海龟的特征是拥有一个巨大而流线型的龟壳，并且头部和四肢无法缩回壳内。与其他龟类不同，海龟的四肢和头部无法缩入壳中。它们的四肢已进化成适合游泳的鳍状肢，因此在陆地上活动时非常脆弱。
  </p>
  ...
  />
  <p>
    长颈鹿以其修长高大的外形而闻名。它们的背部有一个类似骆驼的小驼峰，身上的斑纹则与豹子相似。由于这些特征的结合，有些人将长颈鹿称为"骆驼豹"。这正是长颈鹿的物种名称"camelopardalis"的由来。
  </p>
  ...
  />
  <p>
    大象是现存最大的陆地动物，拥有庞大的身躯、大耳朵和长长的象鼻。大象的长鼻子功能多样，可以用来拾取物品、发出警告声、与其他大象打招呼，或者吸水来饮用或洗澡。
  </p>
  ...
  />
  <p>
    海豚的颜色因种类而异，从白色、珍珠色、粉色到较深的棕色、灰色、蓝色和黑色不等。它们拥有光滑的皮肤、鳍状肢和背鳍。它们的吻部细长，约有100颗牙齿，身体呈流线型。头顶有一个单一的呼吸孔，上面有一个可打开的瓣膜，露出一对鼻孔。海豚浮出水面时，就用这些鼻孔来呼吸。
  </p>
</ion-content>
```