...
<ion-content [scrollY]="false">
  <div class="ion-content-scroll-host ion-padding">
    ...
    />
    <p>
      犀牛（Rhinoceros）这个名字来源于它最显著的特征之一：它的角。单词“rhinoceros”源自希腊语，rhino意为“鼻子”，ceros意为“角”。不同种类的犀牛，角的数量也不同。两种非洲犀牛（黑犀牛和白犀牛）以及苏门答腊犀牛有两个角，而爪哇犀牛和印度犀牛只有一个角。
    </p>
    ...
    />
    <p>
      海龟的特征是拥有一个大型流线型的甲壳，以及无法缩回壳内的头部和四肢。与其他龟类不同，海龟无法将四肢和头部缩回壳内。它们的四肢是适应游泳的鳍状肢，因此在陆地上时非常脆弱。
    </p>
    ...
    />
    <p>
      长颈鹿以其修长高挑的外形而闻名。它们的背部有一个像骆驼一样的小驼峰，并且拥有类似豹子的斑点图案。由于这些特征的结合，一些人曾称长颈鹿为“骆驼豹”。这就是长颈鹿的物种名称“camelopardalis”的由来。
    </p>
    ...
    />
    <p>
      大象是现存最大的陆地动物，拥有庞大的身躯、大耳朵和长长的鼻子。大象的长鼻子功能多样，可以用来拾取物品、发出警告声、问候其他大象，或者吸水饮用和洗澡。
    </p>
    ...
    />
    <p>
      海豚的颜色因物种而异，从白色、珍珠色、粉色到更深的棕色、灰色、蓝色和黑色。它们有光滑的皮肤、鳍状肢和一个背鳍。它们拥有细长的吻部，约有100颗牙齿，以及流线型的身体。它们头顶有一个单一的呼吸孔，上面有一个可以打开露出一对鼻孔的皮瓣。海豚浮出水面时就用这些鼻孔呼吸。
    </p>
  </div>
</ion-content>
```