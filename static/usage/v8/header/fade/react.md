  ...
  return (
    <>
      ...
      <IonContent className="ion-padding">
        ...
        />
        <p>
          犀牛的名字来源于它最显著的特征之一：它的角。“犀牛”这个词源自希腊语，rhino意为“鼻子”，ceros意为“角”。犀牛角的数量因物种而异。两种非洲犀牛（黑犀牛和白犀牛）以及苏门答腊犀牛有两角，而爪哇犀牛和印度犀牛只有一角。
        </p>
        ...
        />
        <p>
          海龟的特点是拥有一个巨大、流线型的甲壳，以及无法缩回的头和四肢。与其他龟类不同，海龟无法将四肢和头部缩回壳内。它们的四肢已进化成适合游泳的鳍状肢，因此在陆地上时非常脆弱。
        </p>
        ...
        />
        <p>
          长颈鹿以其高挑修长的外形而闻名。它们的背部有一个像骆驼一样的小驼峰，身上的斑点图案则类似于豹子。由于这些特征的结合，有些人曾称长颈鹿为“骆驼豹”。这也正是长颈鹿学名“camelopardalis”的由来。
        </p>
        ...
        />
        <p>
          大象是现存最大的陆地动物，拥有庞大的身躯、大耳朵和长长的鼻子。大象的长鼻子具有多种功能，可以用来拾取物品、发出警告、与其他大象打招呼，或者吸水饮用和洗澡。
        </p>
        ...
        />
        <p>
          海豚的颜色因物种而异，从白色、珍珠色、粉色到较深的棕色、灰色、蓝色和黑色都有。它们拥有光滑的皮肤、鳍状肢和一个背鳍。它们有一个细长的吻部，大约有100颗牙齿，身体呈流线型。头顶有一个单一的呼吸孔，这个呼吸孔有一个可以打开的瓣膜，露出一对鼻孔。当海豚浮出水面时，就用这些鼻孔进行呼吸。
        </p>
      </IonContent>
    </>
  );
