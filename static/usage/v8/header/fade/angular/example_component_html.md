...
<ion-content class="ion-padding">
  ...
  />
  <p>
    犀牛的名字来源于其最显著的特征之一：它的角。"犀牛"（rhinoceros）一词源自希腊语，其中"rhino"意为"鼻子"，"ceros"意为"角"。不同种类的犀牛角的数量也不同。两种非洲犀牛（黑犀牛和白犀牛）以及苏门答腊犀牛都有两只角，而爪哇犀牛和独角犀牛则只有一只角。
  </p>
  ...
  />
  <p>
    海龟的特征是拥有一个大型流线型的甲壳，以及无法缩回的头部和四肢。与其他龟类不同，海龟无法将四肢和头部缩回壳内。它们的四肢已经演化成适应游泳的鳍状肢，因此在陆地上时非常脆弱。
  </p>
  ...
  />
  <p>
    长颈鹿以其高挑修长的外形而闻名。它们的背上有一个类似骆驼的小驼峰，身上的斑点图案则与豹子相似。由于这些特征的结合，有些人将长颈鹿称为"骆驼豹"。长颈鹿的物种名"camelopardalis"（长颈鹿属）正是由此而来。
  </p>
  ...
  />
  <p>
    大象是现存最大的陆地动物，拥有庞大的身躯、大耳朵和长长的象鼻。大象的长鼻子功能多样，可以用来拾取物品、发出警告的吼声、与其他大象打招呼，或者吸水用于饮用或洗澡。
  </p>
  ...
  />
  <p>
    海豚的颜色因物种而异，从白色、珍珠色、粉色到更深的棕色、灰色、蓝色和黑色都有。它们拥有光滑的皮肤、鳍状肢和背鳍。它们有着细长的吻部，大约有100颗牙齿，以及流线型的身体。它们的头顶有一个呼吸孔，上面有一个瓣膜，打开后会露出一对鼻孔。海豚浮出水面时就用这些鼻孔呼吸。
  </p>
</ion-content>
```