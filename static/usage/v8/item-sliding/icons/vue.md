...
<template>
  <ion-list>
    <ion-item-sliding>
      ...
      <ion-item>
        <ion-label>仅包含图标的滑动条目</ion-label>
      </ion-item>
    ...
    <ion-item-sliding>
      ...
      <ion-item>
        <ion-label>带左侧图标的滑动条目</ion-label>
      </ion-item>
    ...
    <ion-item-sliding>
      ...
      <ion-item>
        <ion-label>带右侧图标的滑动条目</ion-label>
      </ion-item>
    ...
    <ion-item-sliding>
      ...
      <ion-item>
        <ion-label>带顶部图标的滑动条目</ion-label>
      </ion-item>
    ...
    <ion-item-sliding>
      ...
      <ion-item>
        <ion-label>带底部图标的滑动条目</ion-label>
      </ion-item>
