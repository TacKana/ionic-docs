...
<template>
  ...
  <ion-item-divider color="primary">
    <ion-label>主色</ion-label>
  </ion-item-divider>
  <ion-item-divider color="secondary">
    <ion-label>次要色</ion-label>
  </ion-item-divider>
  <ion-item-divider color="tertiary">
    <ion-label>第三色</ion-label>
  </ion-item-divider>
  <ion-item-divider color="success">
    <ion-label>成功色</ion-label>
  </ion-item-divider>
  <ion-item-divider color="warning">
    <ion-label>警告色</ion-label>
  </ion-item-divider>
  <ion-item-divider color="danger">
    <ion-label>危险色</ion-label>
  </ion-item-divider>
  <ion-item-divider color="light">
    <ion-label>浅色</ion-label>
  </ion-item-divider>
  <ion-item-divider color="medium">
    <ion-label>中性色</ion-label>
  </ion-item-divider>
