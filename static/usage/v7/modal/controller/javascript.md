...
<ion-content class="ion-padding">
  ...
  <p id="message">此模态框示例使用 modalController 来呈现和关闭模态框。</p>
</ion-content>
...
<script>
  var openModal = async () => {
    ...
    div.innerHTML = `
      ...
      <ion-content class="ion-padding">
        <ion-item>
          <ion-input type="text" label-placement="stacked" label="输入您的姓名" placeholder="您的姓名"></ion-input>
        </ion-item>
      </ion-content>
      `;
    ...
    if (role === 'confirm') {
      document.querySelector('#message').innerHTML = `你好，${data}！`;
    }
  };
