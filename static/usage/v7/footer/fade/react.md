  ...
  return (
    <>
      <IonContent className="ion-padding">
        ...
        />
        <p>
          犀牛因其最显著的特征之一——角而得名。Rhinoceros一词源于希腊语，rhino意为"鼻子"，ceros意为"角"。不同种类的犀牛角数量各异。两种非洲犀牛（黑犀牛和白犀牛）以及苏门答腊犀牛有两个角，而爪哇犀牛和印度犀牛只有一个角。
        </p>
        ...
        />
        <p>
          海龟的特征是拥有流线型的大壳以及无法缩回壳内的头和四肢。与其他龟类不同，海龟不能将四肢和头缩入壳中。它们的四肢是适应游泳的鳍状肢，因此在陆地上时十分脆弱。
        </p>
        ...
        />
        <p>
          长颈鹿以其修长高挑的外形而闻名。它们背上有一个类似骆驼的小驼峰，身上有着与豹子相似的斑点图案。由于这些特征的结合，有些人称长颈鹿为"骆驼豹"。长颈鹿的物种名"camelopardalis"正是由此而来。
        </p>
        ...
        />
        <p>
          海豚的颜色因种类而异，从白色、珍珠色、粉色到更深的棕色、灰色、蓝色和黑色不等。它们拥有光滑的皮肤、鳍状肢和背鳍。它们有细长的吻部，约100颗牙齿，身体呈流线型。头顶有一个呼吸孔，上面有一个可打开露出双鼻孔的皮瓣。海豚浮出水面时通过这些鼻孔呼吸。
        </p>
      </IonContent>
