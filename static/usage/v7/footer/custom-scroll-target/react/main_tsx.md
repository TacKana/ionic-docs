    ...
    <>
      <IonContent scrollY={false}>
        <div className="ion-content-scroll-host ion-padding">
          ...
          />
          <p>
            犀牛的名字来源于其最显著的特征之一：它的角。“rhinoceros”一词源自希腊语，其中“rhino”意为“鼻子”，“ceros”意为“角”。不同种类的犀牛拥有的角数量也不同。两种非洲犀牛（黑犀牛和白犀牛）以及苏门答腊犀牛有两个角，而爪哇犀牛和独角犀牛则只有一个角。
          </p>
          ...
          />
          <p>
            长颈鹿以其修长高大的外形而闻名。它们的背部有一个类似骆驼的小驼峰，并且拥有类似豹子的斑点图案。由于这些特征的结合，有些人称长颈鹿为“骆驼豹”。这正是长颈鹿的物种名称“camelopardalis”的由来。
          </p>
          ...
          />
          <p>
            大象是现存最大的陆地动物，拥有巨大的身躯、大耳朵和长长的鼻子。大象的长鼻子具有多种功能，可以用来拾取物体、发出警告声、问候其他大象，或者吸水饮用或洗澡。
          </p>
          ...
          />
          <p>
            海豚的颜色因物种而异，从白色、珍珠色和粉色到更深的棕色、灰色、蓝色和黑色。它们拥有光滑的皮肤、鳍状肢和一个背鳍。它们有一个细长的吻部，约有100颗牙齿，身体呈流线型。它们的头部顶端有一个喷水孔，上面有一个可以打开的皮瓣，露出一对鼻孔。海豚浮出水面时，就用这些鼻孔进行呼吸。
          </p>
        </div>
      </IonContent>
