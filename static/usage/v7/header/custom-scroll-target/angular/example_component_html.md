...
<ion-content [scrollY]="false">
  <div class="ion-content-scroll-host ion-padding">
    ...
    />
    <p>
      犀牛的名字来源于其最显著的特征之一：它的角。犀牛（rhinoceros）一词源自希腊语 rhino（意为“鼻子”）和 ceros（意为“角”）。不同种类的犀牛角数量也不同。两种非洲犀牛（黑犀牛和白犀牛）以及苏门答腊犀牛有两个角，而爪哇犀牛和独角犀牛则只有一个角。
    </p>
    ...
    />
    <p>
      海龟的特征是拥有流线型的大甲壳，以及无法缩回的头部和四肢。与其他龟类不同，海龟无法将四肢和头部缩进壳内。它们的四肢已经进化成适合游泳的鳍状肢，因此在陆地上时非常脆弱。
    </p>
    ...
    />
    <p>
      长颈鹿以其高大修长的外形而闻名。它们背上有一个类似骆驼的小驼峰，身上还有类似豹子的斑点图案。正因为结合了这些特征，有些人曾将长颈鹿称为“骆驼豹”。这也正是长颈鹿的物种名“camelopardalis”的由来。
    </p>
    ...
    />
    <p>
      大象是现存最大的陆地动物，拥有庞大的身躯、大耳朵和长长的象鼻。大象的长鼻子功能多样，可以用来拾取物品、发出警告声、问候其他大象，或吸水用于饮用或洗澡。
    </p>
    ...
    />
    <p>
      海豚的颜色因种类而异，从白色、珍珠色、粉红色到较深的棕色、灰色、蓝色和黑色不等。它们有着光滑的皮肤、鳍状肢和背鳍。它们拥有细长的喙部，约有100颗牙齿，身体呈流线型。头顶有一个喷水孔，上面覆盖着一个可以打开露出双鼻孔的皮瓣。海豚浮出水面时就用这些鼻孔进行呼吸。
    </p>
  </div>
</ion-content>
```