...
<template>
  ...
  <ion-content :fullscreen="true">
    ...
    <div class="ion-padding">
      ...
      />
      <p>
        犀牛的名字来源于其最显著的特征之一：它的角。“犀牛”这个词源自希腊语，rhino 意为“鼻子”，ceros 意为“角”。不同种类的犀牛，角的数量也不同。两种非洲犀牛（黑犀牛和白犀牛）以及苏门答腊犀牛拥有两只角，而爪哇犀牛和独角犀牛则只有一只角。
      </p>
      ...
      />
      <p>
        海龟的特征是拥有大型流线型甲壳，以及无法缩回的头部和四肢。与其他龟类不同，海龟不能将四肢和头部缩入壳内。它们的四肢演化为适合游泳的鳍状肢，因此在陆地上时非常脆弱。
      </p>
      ...
      />
      <p>
        长颈鹿以其修长高挑的外形而闻名。它们的背部有一个像骆驼一样的小驼峰，身上的斑点图案则类似于豹子。由于这些特征的结合，一些人曾称长颈鹿为“骆驼豹”。这也正是长颈鹿物种学名“camelopardalis”的由来。
      </p>
      ...
      />
      <p>
        海豚的颜色因物种而异，从白色、珍珠色、粉色到较深的棕色、灰色、蓝色和黑色。它们拥有光滑的皮肤、鳍状肢和背鳍。它们有细长的吻部，大约有100颗牙齿，身体呈流线型。它们头顶有一个呼吸孔，上面有一个可以打开露出两个鼻孔的瓣膜。当海豚浮出水面时，就用这些鼻孔进行呼吸。
      </p>
    </div>
  </ion-content>
</template>
